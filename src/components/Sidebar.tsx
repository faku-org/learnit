...
import { Home, Target, BookOpen, Mic } from "lucide-react";
...
export function Sidebar({ currentPath }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 h-screen w-16 flex flex-col items-center py-5 gap-1 bg-card border-r border-border z-50"
    >
      <motion.a
        href="/"
        ...
        title="LearnIt!"
      >
        <span className="font-display text-base leading-none text-accent select-none">
          L!
        </span>
      </motion.a>
